...
import { ArrowLeft, Mail, FileText, XCircle, Phone } from "lucide-react";
  ...
  return (
    <main className="min-h-screen bg-[#050505] text-white py-12 px-4">
      <div className="max-w-3xl mx-auto">
        ...
        {/* Customer Support - Moved to bottom */}
        <section className="mb-16">
          <div className="flex items-center gap-3 mb-6">
          ...
          <div className="bg-white/5 border border-white/10 rounded-[2rem] p-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <a
                href="mailto:kobap2501@gmail.com"
                className="inline-flex items-center justify-center gap-2 px-6 py-4 bg-emerald-600 hover:bg-emerald-500 rounded-xl font-black text-white transition-all active:scale-95 flex-1"
              >
                <Mail size={18} />
                kobap2501@gmail.com
              </a>
              <div
                className="inline-flex items-center justify-center gap-2 px-6 py-4 bg-neutral-700 rounded-xl font-black text-white flex-1"
              >
                <Phone size={18} />
                0766-30-3670
              </div>
